...
<div class="container-fluid">
	...
	<option value="all">All</option>		
     <?php
	$dep_sql2=$con->query("SELECT id, div_name, status, created_by, created_on FROM division_master where status=1");
	while($dep_sql_res2=$dep_sql2->fetch(PDO::FETCH_ASSOC))
	{
		?>
		<option value="<?php echo $dep_sql_res2['id']; ?>"><?php echo $dep_sql_res2['div_name']; ?></option>
		<?php
	}
	?>	
	</select>
